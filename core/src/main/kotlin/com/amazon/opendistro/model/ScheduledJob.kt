...
import com.amazon.opendistro.model.ScheduledJob.Companion.NO_ID
import com.amazon.opendistro.model.ScheduledJob.Companion.NO_VERSION
...
interface ScheduledJob : ToXContentObject {
    ...
    companion object {
        ...
        const val SCHEDULED_JOBS_INDEX = ".opendistro-scheduled-jobs"

...
import com.amazon.opendistroforelasticsearch.alerting.resthandler.RestDisableAlertingAction
...
internal class AlertingPlugin : PainlessExtension, ActionPlugin, ScriptPlugin, Plugin() {
    ...
    override fun getRestHandlers(
        ...
        return listOf(RestGetMonitorAction(settings, restController),
                ...
                RestDisableAlertingAction(settings, restController),
    ...
    override fun getSettings(): List<Setting<*>> {
        return listOf(
                ...
                AlertingSettings.ALERTING_ENABLED,

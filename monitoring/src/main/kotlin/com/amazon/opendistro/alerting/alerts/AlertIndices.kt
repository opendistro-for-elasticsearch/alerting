...
import com.amazon.opendistro.alerting.alerts.AlertIndices.Companion.ALERT_INDEX
import com.amazon.opendistro.alerting.alerts.AlertIndices.Companion.HISTORY_WRITE_INDEX
 ...
 * date based index. The frequency of rolling over indices is controlled by the `opendistro.monitoring.alert_rollover_period` setting.
 *
